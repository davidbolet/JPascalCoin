...
public interface PascalCoinService {
    ...
    @Headers({"Content-Type: application/json","User-Agent: JPascalCoin"})
	@POST("/")
    Call<OpResult<PascPublicKey>> getWalletPubKey(@Body Map<String, Object> body);
	
    @Headers({"Content-Type: application/json","User-Agent: JPascalCoin"})
	@POST("/")
    Call<OpResult<List<PascPublicKey>>> getWalletPubKeys(@Body Map<String, Object> body);
    ...
    @Headers({"Content-Type: application/json","User-Agent: JPascalCoin"})
	@POST("/")
    Call<OpResult<PascPublicKey>> decodePubKey(@Body Map<String, Object> body);
    ...
    @Headers({"Content-Type: application/json","User-Agent: JPascalCoin"})
   	@POST("/")
    Call<OpResult<PascPublicKey>> addNewKey(@Body Map<String, Object> body);
    ...
    @Headers({"Content-Type: application/json","User-Agent: JPascalCoin"})
 	@POST("/")
	Call<OpResult<PascPublicKey>> importPubKey(@Body Map<String, Object> body);
