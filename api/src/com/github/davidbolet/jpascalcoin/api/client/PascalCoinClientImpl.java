...
public class PascalCoinClientImpl implements PascalCoinClient {
	...
	@Override
	public void addNodeAsync(String nodes, Callback<OpResult<Integer>> addNodeCallback) {
		Map<String,Object> body = getRPCBody();
		Map<String,Object> params = new HashMap<>();
		body.put("method","addnode");
		params.put("nodes", nodes);
		body.put("params",params);
		Call<OpResult<Integer>> addNodeCall= pascalCoinService.addNode(body);
		addNodeCall.enqueue(addNodeCallback);
	}
	...
	@Override
	public void getAccountAsync(Integer account, Callback<OpResult<Account>> getAccountCallback) {
		Map<String,Object> body = getRPCBody();
		Map<String,Object> params = new HashMap<>();
		body.put("method","getaccount");
		params.put("account", account);
		body.put("params",params);
		Call<OpResult<Account>> accountCall= pascalCoinService.getAccount(body);
		accountCall.enqueue(getAccountCallback);
	}
	...
	@Override
	public void findAccountsAsync(String name, Integer type, Integer start, Integer max, Callback<OpResult<List<Account>>> findAccountsCallback) {
		Map<String,Object> body = getRPCBody();
		Map<String,Object> params = new HashMap<>();
		body.put("method","findaccounts");
		if (name!=null && !"".equals(name))
		...
		body.put("params",params);
		Call<OpResult<List<Account>>> findAccountsCall= pascalCoinService.findAccounts(body);
		findAccountsCall.enqueue(findAccountsCallback);
	}
	
	
	@Override
	public List<Account> findAccounts(String name, Boolean exact, Integer type, Boolean listed, String encPubKey, String b58PubKey, Double minBalance, Double maxBalance, Integer start, Integer max) {
		List<Account> result = null;
		Map<String,Object> body = getRPCBody();
		Map<String,Object> params = new HashMap<>();
		body.put("method","findaccounts");
	...
	@Override
	public void findAccountsAsync(String name, Boolean exact, Integer type, Boolean listed, String encPubKey, String b58PubKey, Double minBalance, Double maxBalance, Integer start, Integer max, Callback<OpResult<List<Account>>> findAccountsCallback) {
		Map<String,Object> body = getRPCBody();
		Map<String,Object> params = new HashMap<>();
		body.put("method","findaccounts");
		if (name!=null && !"".equals(name))
	...
	@Override
	public void getWalletAccountsAsync(String encPubKey, String b58PubKey, Integer start, Integer max, Callback<OpResult<List<Account>>> getWalletAccountsCallback) {
		Map<String,Object> body = getRPCBody();
		Map<String,Object> params = new HashMap<>();
		body.put("method","getwalletaccounts");
		if (encPubKey!=null)
		...
		body.put("params",params);
		Call<OpResult<List<Account>>> walletAccountsCall= pascalCoinService.getWalletAccounts(body);
		walletAccountsCall.enqueue(getWalletAccountsCallback);
	}
	...
	@Override
	public void getWalletAccountsCountAsync(String encPubKey, String b58PubKey, Callback<OpResult<Integer>> getWalletAccountsCountCallback) {
		Map<String,Object> body = getRPCBody();
		Map<String,Object> params = new HashMap<>();
		body.put("method","getwalletaccountscount");
		if (encPubKey!=null)
		...
		body.put("params",params);
		Call<OpResult<Integer>> walletAccountsCountCall= pascalCoinService.getWalletAccountsCount(body);
		walletAccountsCountCall.enqueue(getWalletAccountsCountCallback);
		
	}

	@Override
	public PascPublicKey getWalletPubKey(String encPubKey, String b58PubKey) {
		PascPublicKey result = null;
		Map<String,Object> body = getRPCBody();
		Map<String,Object> params = new HashMap<>();
		...
		if (b58PubKey!=null)
			params.put("b58_pubkey", b58PubKey);
		body.put("params",params);
		Call<OpResult<PascPublicKey>> walletPubCall= pascalCoinService.getWalletPubKey(body);
		try {
			Response<OpResult<PascPublicKey>> response = walletPubCall.execute();
			if (response.body().isError())
			{
				logger.log(Level.SEVERE, response.body().getErrorMessage());
				throw response.body().getError();
	...
	@Override
	public void getWalletPubKeyAsync(String encPubKey, String b58PubKey, Callback<OpResult<PascPublicKey>> getWalletPubKeyCallback) {
		Map<String,Object> body = getRPCBody();
		Map<String,Object> params = new HashMap<>();
		body.put("method","getwalletpubkey");
		if (encPubKey!=null)
		...
		body.put("params",params);
		Call<OpResult<PascPublicKey>> walletPubCall= pascalCoinService.getWalletPubKey(body);
		walletPubCall.enqueue(getWalletPubKeyCallback);
	}

	@Override
	public List<PascPublicKey> getWalletPubKeys(Integer start, Integer max) {
		List<PascPublicKey> result = null;
		Map<String,Object> body = getRPCBody();
		Map<String,Object> params = new HashMap<>();
		...
		if (max!=null)
			params.put("max", max);
		body.put("params",params);
		Call<OpResult<List<PascPublicKey>>> walletPubKeysCall= pascalCoinService.getWalletPubKeys(body);
		try {
			Response<OpResult<List<PascPublicKey>>> response = walletPubKeysCall.execute();
			if (response.body().isError())
			{
				logger.log(Level.SEVERE, response.body().getErrorMessage());
				throw response.body().getError();
	...
	@Override
	public void getWalletPubKeysAsync(Integer start, Integer max, Callback<OpResult<List<PascPublicKey>>> getWalletPubKeyCallback) {
		Map<String,Object> body = getRPCBody();
		Map<String,Object> params = new HashMap<>();
		body.put("method","getwalletpubkeys");
		if (start!=null)
		...
		body.put("params",params);
		Call<OpResult<List<PascPublicKey>>> walletPubKeysCall= pascalCoinService.getWalletPubKeys(body);
		walletPubKeysCall.enqueue(getWalletPubKeyCallback);
	}
	...
	@Override
	public PascPublicKey decodePubKey(String encPubKey, String b58PubKey) {
		PascPublicKey result = null;
		Map<String,Object> body = getRPCBody();
		Map<String,Object> params = new HashMap<>();
		...
		if (b58PubKey!=null)
			params.put("b58_pubkey", b58PubKey);
		body.put("params",params);
		Call<OpResult<PascPublicKey>> decodePubKeyCall= pascalCoinService.decodePubKey(body);
		try {
			Response<OpResult<PascPublicKey>> response = decodePubKeyCall.execute();
			if (response.body().isError())
			{
				logger.log(Level.SEVERE, response.body().getErrorMessage());
				throw response.body().getError();
	...
	@Override
	public PascPublicKey importPubKey(String name, String b58PubKey) {
		PascPublicKey result = null;
		Map<String,Object> body = getRPCBody();
		Map<String,Object> params = new HashMap<>();
		...
		body.put("params",params);
		Call<OpResult<PascPublicKey>> decodePubKeyCall= pascalCoinService.importPubKey(body);
		try {
			Response<OpResult<PascPublicKey>> response = decodePubKeyCall.execute();
			if (response.body().isError())
			{
	...
	@Override
	public PascPublicKey addNewKey(KeyType ecNid, String name) {
		PascPublicKey result = null;
		...
		params.put("name", name);
		body.put("params",params);
		Call<OpResult<PascPublicKey>> addNewKeyCall= pascalCoinService.addNewKey(body);
		try {
			Response<OpResult<PascPublicKey>> response = addNewKeyCall.execute();
			if (response.body().isError())
			{
				logger.log(Level.SEVERE, response.body().getErrorMessage());
				throw response.body().getError();
