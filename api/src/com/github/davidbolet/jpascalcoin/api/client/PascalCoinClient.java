...
public interface PascalCoinClient {
			...
			* @return Returns a JSON Array with "Public Key Object" */
			List<PascPublicKey> getWalletPubKeys(Integer start, Integer max);
			...
			* @param max: Integer (optional, default = 100). If provided, will return max public keys. If not provided, max=100 by default
			 ...
			 */
			void getWalletPubKeysAsync(Integer start, Integer max, Callback<OpResult<List<PascPublicKey>>> getWalletPubKeyCallback);
			...
			PascPublicKey getWalletPubKey(String encPubKey, String b58PubKey);
			 ...
			 * @param getWalletPubKeyCallback: Callback function to execute when result is ready
			 */
			void getWalletPubKeyAsync(String encPubKey, String b58PubKey, Callback<OpResult<PascPublicKey>> getWalletPubKeyCallback);
			...
			*/
			 ...
			 * @param encPubKey will search accounts with this key (provided in encoded format). In this case the "start" param value is the position of indexed public keys list instead of accounts numbers
			 * @param b58PubKey will search accounts with this key (provided in b58 format). In this case the "start" param value is the position of indexed public keys list instead of accounts numbers
			 ...
			 * @return list of accounts matching selected criteria
			 */
			List<Account> findAccounts(String name, Boolean exact, Integer type, Boolean listed, String encPubKey, String b58PubKey, Double minBalance, Double maxBalance,
			 ...
			 */
			void findAccountsAsync(String name, Boolean exact, Integer type, Boolean listed, String encPubKey, String b58PubKey, Double minBalance, Double maxBalance, Integer start, Integer max, Callback<OpResult<List<Account>>> findAccountsCallback);
			 ...
			 * Note: If use enc_pubkey and b58_pubkey together and is not the same public key, will return an error
			 * @return Returns a JSON Object with a "Public Key Object" */
			PascPublicKey decodePubKey(String encPubKey, String b58PubKey);
			 ...
			 * */
			PascPublicKey addNewKey(KeyType ecNid, String name);
			 ...
			 * @return PublickKey object that given string represents 
			 */
			PascPublicKey importPubKey(String name, String b58PubKey);
